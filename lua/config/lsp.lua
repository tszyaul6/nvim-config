...
vim.api.nvim_create_autocmd('LspAttach', {
    callback = function(ev)
        ...
        vim.keymap.set("n", "gnd", function() vim.diagnostic.jump({ count = 1, float = true }) end, keymap_opt)
        vim.keymap.set("n", "gpd", function() vim.diagnostic.jump({ count = -1, float = true }) end, keymap_opt)
